            ...
            <div id="greeting box" className="card">
              ...
              <div className="card-body">
                ...
                <div className="form-group">
                  <input required type="text" name="name" className="form-control" placeholder="Enter Your name" />
                </div>
                <div className="d-grid gap-2 my-3">
                  <button type="submit" className="btn btn-outline-dark">Create Your Link</button>
                </div>
              </form>
            </div>
          </div>
